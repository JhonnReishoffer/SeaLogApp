...
export default function LoginPage() {
  ...
  function handleGoogleLogin() {
    ...
    loginWithGoogle(mockName, mockEmail)
  }
      ...
      <div className="relative z-10 flex w-full max-w-md flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-sm text-muted-foreground">
            Controle de Qualidade Alimentar Maritimo
          </p>
        </div>
        ...
        <Card className="w-full">
          ...
          <CardContent>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground select-none"
                    tabIndex={-1}
                  >
                    {showPassword ? (
            ...
            <p className="mt-6 text-center text-xs text-muted-foreground">
              Novo por aqui? Crie uma conta informando seu e-mail e senha acima.
            </p>
          </CardContent>
        </Card>
        ...
        <p className="text-xs text-muted-foreground">
          SeaLogApp v1.0 - Todos os direitos reservados
        </p>
      </div>
    </div>
  )
